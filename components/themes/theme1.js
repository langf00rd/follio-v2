...
const Hero = ({ customStyle, greeting, tagline, work, profilePhoto, socials, email }) => {
...
const Theme1 = ({ data = {}, editMode = false }) => {
    ...
    if (editMode) return <div className={previewStyles.body}>
        <Hero email={email} socials={socials} profilePhoto={profilePhoto} tagline={tagline} work={work} customStyle={previewStyles} />
    ...
    if (!editMode) return <div className={styles.body}>
        ...
        <Hero email={data.email} socials={data.socials} profilePhoto={data.profilePhoto} tagline={data.tagline} work={data.work} customStyle={styles} />
