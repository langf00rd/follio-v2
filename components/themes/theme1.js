...
const styles = {
    ...
    projectCard: `p-5 border border-[#f1f1f1] rounded-xl text-left m-5 mx-0 lg:mr-5`,
...
const previewStyles = {
    ...
    logo: `h-[39px] object-cover`,
    body: `text-center bg-white lg:shadow-xl lg:min-w-xl w-screen lg:w-[23vw] text-[1.1rem] lg:h-[80vh] h-[100vh] bg-white   lg:rounded-xl z-30 pb-44 lg:pb-0 overflow-y-scroll`,
    ...
    projectCard: `p-5 border border-[#f1f1f1] rounded-xl text-left m-5 mx-0`,
