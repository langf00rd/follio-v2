...
const previewStyles = {
    ...
    logo: `h-[39px] object-cover`,
    body: `bg-[#FFC600] text-center bg-white lg:shadow-xl lg:min-w-xl w-screen lg:w-[23vw] text-[1.1rem] lg:h-[80vh] h-[100vh] bg-white   lg:rounded-xl z-30 pb-44 lg:pb-0 overflow-y-scroll`,
