...
const FAB = () => {
    return (
        <>
            <Link href="mailto:follioapp@gmail.com" passHref>
                <div className='tooltip fixed lg:right-[30px] right-[20px] shadow-2xl cursor-pointer hover:scale-90 transition bottom-[80px] bg-brand z-50 w-[60px] h-[60px] rounded-full p-3 flex items-center justify-center text-white'>
