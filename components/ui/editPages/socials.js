    ...
    return <div className={layoutStyles.container}>
        ...
        <div className="flex items-center">
            ...
            <div className={inputStyles.socialInput}>
                ...
                <input value={newSocials.twitter} onChange={e => setNewSocials(e.target.value, "twitter")} className={inputStyles.ghostInput} type="text" placeholder="" />
            </div>
        </div>
        <div className="flex items-center">
            ...
            <div className={inputStyles.socialInput}>
                ...
                <input value={newSocials.github} onChange={e => setNewSocials(e.target.value, "github")} className={inputStyles.ghostInput} type="text" placeholder="" />
            </div>
        </div>
        <div className="flex items-center">
            <img src={linkedin.src} alt="" className={styles.socialIcon} />
            <div className={inputStyles.socialInput}>
                <label className={inputStyles.label}>linkedin.com/</label>
                <input value={newSocials.linkedin} onChange={e => setNewSocials(e.target.value, "linkedin")} className={inputStyles.ghostInput} type="text" placeholder="" />
            </div>
        </div>
        <div className="flex items-center">
            ...
            <div className={inputStyles.socialInput}>
                ...
                <input value={newSocials.behance} onChange={e => setNewSocials(e.target.value, "behance")} className={inputStyles.ghostInput} type="text" placeholder="" />
            </div>
        </div>
        <div className="flex items-center">
            ...
            <div className={inputStyles.socialInput}>
                ...
                <input value={newSocials.twitch} onChange={e => setNewSocials(e.target.value, "twitch")} className={inputStyles.ghostInput} type="text" placeholder="" />
            </div>
        </div>
        <div className="flex items-center">
            ...
            <div className={inputStyles.socialInput}>
                ...
                <input value={newSocials.instagram} onChange={e => setNewSocials(e.target.value, "instagram")} className={inputStyles.ghostInput} type="text" placeholder="" />
            </div>
        </div>
        <div className="flex items-center">
            ...
            <div className={inputStyles.socialInput}>
                ...
                <input value={newSocials.stackoverflow} onChange={e => setNewSocials(e.target.value, "stackoverflow")} className={inputStyles.ghostInput} type="text" placeholder="" />
            </div>
        </div>
        <div className="flex items-center">
            ...
            <div className={inputStyles.socialInput}>
                ...
                <input value={newSocials.dribbble} onChange={e => setNewSocials(e.target.value, "dribbble")} className={inputStyles.ghostInput} type="text" placeholder="" />
            </div>
        </div>
        <div className="flex items-center">
            ...
            <div className={inputStyles.socialInput}>
                ...
                <input value={newSocials.discord} onChange={e => setNewSocials(e.target.value, "discord")} className={inputStyles.ghostInput} type="text" placeholder="" />
            </div>
        </div>
        <div className="flex items-center">
            ...
            <div className={inputStyles.socialInput}>
                ...
                <input value={newSocials.youtube} onChange={e => setNewSocials(e.target.value, "youtube")} className={inputStyles.ghostInput} type="text" placeholder="" />
            </div>
        </div>
    </div>
}
