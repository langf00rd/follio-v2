...
const EditPageTabs = () => {
    ...
    return <div className={tabStyles.tabBar}>
        ...
        <p onClick={() => setViewCount(1)} className={viewCount === 1 ? tabStyles.activeTab : tabStyles.tab}>📺 Media</p>
        ...
        <p onClick={() => setViewCount(7)} className={viewCount === 7 ? tabStyles.activeTab : tabStyles.tab}>💳 Shop</p>
