export const layoutStyles = {
    ...
    bottomNav: `flex rounded-full m-3 items-center fixed justify-between bottom-0 w-11/12 ml-5 left-0 bg-white shadow-lg border border-[#cbd5e16b] p-2 pl-5 lg:hidden`,
